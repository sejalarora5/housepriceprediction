...
from production_model import regression_model
...
class Config(BaseModel):
    ...
    feature_config: ModelConfig # <--- Renamed from feature_config to model_settings due to pydantic v2 error
# feature_config
...
def create_and_validate_config(parsed_config: YAML = None) -> Config:
    ...
    _config = Config(
        ...
        feature_config=ModelConfig(**parsed_config.data),
    )
